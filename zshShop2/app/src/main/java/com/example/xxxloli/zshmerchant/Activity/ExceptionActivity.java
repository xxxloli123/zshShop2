...
public class ExceptionActivity extends AppCompatActivity {
    @BindView(R.id.back_rl) RelativeLayout black;
    @BindView(R.id.text_sumbit) TextView sumbit;
    @BindView(R.id.edit_feedback) EditText feedback;
    ...
    @OnClick({R.id.back_rl,R.id.text_sumbit})
        ...
        switch (view.getId()) {
            ...
            case R.id.text_sumbit:
                ...
                jsonSb.append("\",\"title\":\"").append(getString(getIntent().getIntExtra(getString(R.string.title),R.string.terraceFunctionException))).
                        ...
                        append("\",\"userName\":\"").append(getString(R.string.userName)).
                        append("\",\"userPhone\":\"").append(getString(R.string.userPhone)).
                        append("\",\"userId\":\"").append(getString(R.string.userPhone)).append("\"}");
